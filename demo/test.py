...
cur.execute(
    "create table test_dml(col1 int, col2 boolean, col3 varchar, col4 datetime, col5 double, col6 numeric(13,6));")
...
cur.executemany(sql1, ([10, False, 'xugu', '2020-04-09 17:05:32', 3.1415, 123456.789],
                       [11, False, 'xugu', '2020-04-09 17:06:32', 3.1415, 123456.789]))
cur.executemany(sql1, [(12, False, 'xugu', '2020-04-09 17:07:32', 3.1415, 123456.789),
                       (13, False, 'xugu', '2020-04-09 17:08:32', 3.1415, 123456.789)])
